...
//       <Text classList="!font-medium duration-300 hover:scale-[1.01] cursor-pointer border-b-[1px] border-[#ECECEC] !pb-[16px] !pt-[8px]">
//         Tahrirlash
//       </Text>
//       <Text classList="!font-medium duration-300 hover:scale-[1.01] cursor-pointer !text-[#F94D4D] !pt-[16px] !pb-[8px]">
//         O'chirish
//       </Text>
//     </div>
//   );
...
//       </div>
//       <Button
//         onClick={() => navigate(PATH.debtCreate)}
